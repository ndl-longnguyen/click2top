...
// Network-First for navigation (HTML), Stale-While-Revalidate/Cache-First for static assets
self.addEventListener('fetch', (event) => {
  ...
  // Network-First for page navigation so users always get fresh app updates

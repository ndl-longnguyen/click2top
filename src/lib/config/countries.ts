...
// Quick-pick list for top competitive nations
...
// Comprehensive full world list (all ISO 3166-1 alpha-2 countries and territories)
export const COUNTRIES: CountryOption[] = [
  ...
  // Additional world countries in alphabetical order
...
export function getCountryName(code?: string): string {
  ...
  const found = COUNTRIES.find((c) => c.code.toUpperCase() === code.toUpperCase());
  return found ? found.name : 'International';
}

    ...
    <div className="w-full space-y-6 max-w-4xl mx-auto pb-8">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 glass-panel p-2 rounded-2xl border border-white/10">
        <div className="flex items-center gap-1.5 overflow-x-auto w-full sm:w-auto">
          {(['global', 'daily', 'weekly', 'nations', 'hof'] as const).map((tab) => (
            <button
              ...
              className={`px-3.5 py-2 rounded-xl text-xs sm:text-sm font-extrabold tracking-wide uppercase transition-all whitespace-nowrap cursor-pointer ${
                activeTab === tab
                  ? tab === 'nations'
        ...
        <button
          ...
          disabled={loading}
          className="p-2 rounded-xl glass-panel text-slate-400 hover:text-white transition-colors cursor-pointer ml-auto"
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {currentCountry && currentCountry !== 'ALL' && (
              ...
              >
                ...
                <span>My Country ({currentCountry})</span>
              </button>
            )}
            ...
            <select
              ...
              className="px-3 py-1.5 rounded-lg bg-slate-900 border border-white/10 text-xs text-white font-bold focus:outline-none focus:border-amber-400 cursor-pointer"
            >
      ...
      {activeTab === 'nations' && (
        <div className="space-y-6">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-amber-500/40 p-6 bg-gradient-to-r from-red-950/60 via-slate-900 to-amber-950/60 shadow-2xl">
            ...
            <div className="relative z-10 flex flex-wrap items-center justify-between gap-4">
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-black uppercase tracking-wider text-amber-400 bg-amber-500/20 px-3 py-0.5 rounded-full border border-amber-500/30 flex items-center gap-1.5">
                ...
                <h2 className="text-2xl sm:text-3xl font-black text-white mt-1 tracking-wide">
              ...
              <div className="p-3.5 rounded-2xl bg-black/50 border border-amber-500/30 text-right">
                <div className="text-[10px] uppercase font-bold text-slate-400">Representing</div>
                <div className="text-lg font-black text-amber-300 flex items-center justify-end gap-1.5 mt-0.5">
                  <span className="text-2xl">{getCountryFlag(currentCountry)}</span>
          ...
          {nationalRivalry && (
            <div className="relative overflow-hidden rounded-2xl border border-sky-500/30 p-4 bg-gradient-to-r from-sky-950/40 via-slate-900 to-black/60 shadow-lg">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm sm:text-base font-bold text-white mt-0.5 flex items-center gap-2">
                      <span>{getCountryFlag(nationalRivalry.userCountry)} {getCountryName(nationalRivalry.userCountry)}</span>
          ...
          {topThreeNations.length >= 3 && (
            <div className="grid grid-cols-3 gap-2 sm:gap-4 items-end pt-8 pb-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-xs sm:text-sm font-black text-slate-200 text-center truncate max-w-full">
                ...
                <div className="w-full h-24 sm:h-28 mt-2 rounded-t-2xl bg-gradient-to-t from-slate-800 to-slate-600/80 border-t-2 border-x-2 border-slate-400/50 flex flex-col items-center justify-center shadow-lg">
                  <span className="text-2xl sm:text-3xl font-black text-slate-200">🥈</span>
                  <span className="text-[10px] uppercase font-bold text-slate-300 mt-1">2nd Place</span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center">
                <div className="relative mb-2">
                  <Crown className="w-6 h-6 text-amber-400 absolute -top-6 left-1/2 -translate-x-1/2 animate-pulse" />
                  <div className="text-4xl sm:text-5xl drop-shadow-[0_0_15px_rgba(245,158,11,0.6)]">
                    {getCountryFlag(topThreeNations[0].country)}
                  </div>
                </div>
                <div className="text-sm sm:text-base font-black text-amber-300 text-center truncate max-w-full">
                ...
                <div className="w-full h-32 sm:h-36 mt-2 rounded-t-2xl bg-gradient-to-t from-amber-700 via-yellow-600 to-amber-500 border-t-2 border-x-2 border-yellow-300 flex flex-col items-center justify-center shadow-[0_0_25px_rgba(245,158,11,0.4)]">
                  <span className="text-3xl sm:text-4xl font-black text-slate-950">🥇</span>
                  <span className="text-[10px] sm:text-xs uppercase font-black text-slate-950 mt-1 tracking-wider">
                    WORLD CHAMPION
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-xs sm:text-sm font-black text-amber-200/80 text-center truncate max-w-full">
                  {getCountryName(topThreeNations[2].country)}
                </div>
                <div className="text-[10px] sm:text-xs font-mono text-slate-400 mt-0.5">
                  {topThreeNations[2].totalScore.toLocaleString()} ⚡
                </div>
                <div className="w-full h-20 sm:h-24 mt-2 rounded-t-2xl bg-gradient-to-t from-amber-900 to-amber-800/80 border-t-2 border-x-2 border-amber-600/50 flex flex-col items-center justify-center shadow-lg">
                  <span className="text-2xl sm:text-3xl font-black text-amber-500">🥉</span>
                  <span className="text-[10px] uppercase font-bold text-amber-300 mt-1">3rd Place</span>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="glass-panel rounded-2xl overflow-hidden border border-white/10 shadow-xl">
            <div className="px-4 py-3 bg-white/5 text-[11px] font-extrabold text-slate-400 uppercase tracking-wider grid grid-cols-12 gap-2">
              ...
              <span className="col-span-5 sm:col-span-5">Nation</span>
              <span className="hidden sm:block sm:col-span-3 text-center">National MVP</span>
              <span className="col-span-5 sm:col-span-3 text-right">Total Energy</span>
            </div>
                  ...
                  >
                    ...
                    <div className="col-span-2 sm:col-span-1 text-center font-black">
                      ...
                      {!isGold && !isSilver && !isBronze && (
                        <span className="text-slate-400 font-mono text-sm">#{nation.rank}</span>
                      )}
                    </div>

                    {/* Country Flag & Name */}
                    <div className="col-span-5 sm:col-span-5 flex items-center gap-2.5 min-w-0">
                      <span className="text-2xl flex-shrink-0" title={getCountryName(nation.country)}>
                        {getCountryFlag(nation.country)}
                      </span>
                      <div className="min-w-0">
                        <div className="font-bold text-sm sm:text-base text-white flex items-center gap-1.5 truncate">
                          <span className="truncate">{getCountryName(nation.country)}</span>
                          {isUserCountry && (
                            <span className="text-[10px] font-extrabold uppercase bg-sky-500 text-slate-950 px-1.5 py-0.2 rounded-md flex-shrink-0">
                              YOUR NATION
                            </span>
                          )}
                        </div>
                        <div className="text-[11px] text-slate-400">
                          {nation.playerCount} Active Clickers
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-lg" title={getCountryName(topOneWinner.country)}>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <Link
                          ...
                          className="font-black text-base text-white hover:text-amber-400 transition-colors flex items-center gap-1.5"
                        >
                          <span className="text-base" title={getCountryName(winner.country)}>
                  ...
                  entries.map((player) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Player Name & Bio */}
                        <div className="col-span-6 sm:col-span-7 pr-2 min-w-0">
                          <Link
                          ...
                          >
                            <span className="text-base flex-shrink-0" title={getCountryName(player.country)}>

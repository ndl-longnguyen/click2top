-- ==============================================================================
-- CLICK 2 TOP — Complete Database Schema & Migrations (Unified for Supabase)
-- Target Project: https://supabase.com/dashboard/project/gwytilquneeexsxlpyen/sql/new
-- ==============================================================================
...
-- 8. FCM Push Device Tokens (Flexible for both registered UUID and guest accounts)
